<!-- The PR title becomes a release-notes line: write it as an imperative sentence ("Add the Anvil Rain event"). -->
...
<!-- How you checked it: tests added, `./gradlew build`, in-game steps (26.2 / 26.3, singleplayer / server). -->
