...
`Client` / `Server` are the environment tags; drop the one your mod does not support.
...
The workflows live in `nezo32/enchantaholic` for now. The recommended next step is a dedicated
