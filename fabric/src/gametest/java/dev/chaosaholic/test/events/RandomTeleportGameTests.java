...
/**
 * Gametests of random_teleport. TODO(random_teleport): replace this placeholder with real tests when the event is implemented
...
public class RandomTeleportGameTests {
	...
	public void registered(GameTestHelper h) {
		h.assertTrue(EventRegistry.get("random_teleport") != null, "random_teleport registered");
		h.succeed();
	}
}
