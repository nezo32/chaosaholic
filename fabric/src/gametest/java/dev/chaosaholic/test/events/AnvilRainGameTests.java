...
/**
 * Gametests of anvil_rain. TODO(anvil_rain): replace this placeholder with real tests when the event is implemented
...
public class AnvilRainGameTests {
	...
	public void registered(GameTestHelper h) {
		h.assertTrue(EventRegistry.get("anvil_rain") != null, "anvil_rain registered");
		h.succeed();
	}
}
